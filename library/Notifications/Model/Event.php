...
class Event extends Model
{
    ...
    public static function mapSeverity(?string $severity): ?string
    {
        return match ($severity) {
            'ok'      => t('Ok', 'noma.severity'),
            'crit'    => t('Critical', 'noma.severity'),
            'warning' => t('Warning', 'noma.severity'),
            'err'     => t('Error', 'noma.severity'),
            'debug'   => t('Debug', 'noma.severity'),
            'info'    => t('Information', 'noma.severity'),
            'alert'   => t('Alert', 'noma.severity'),
            'emerg'   => t('Emergency', 'noma.severity'),
            'notice'  => t('Notice', 'noma.severity'),
            default   => null,
        };
    }
